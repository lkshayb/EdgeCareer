...
const HeroSection = () => {
  ...
  return (
    <section className="w-full pt-32 md:pt-36 pb-10 relative overflow-hidden" ref={containerRef}>
      ...
      <div className="space-y-6 text-center">
        ...
        <div className="space-y-6 mx-auto">
          <SequenceItem animation="slideUp" delay={0.1}>
            <h1 className="text-3xl pt-20 font-bold md:text-4xl lg:text-5xl xl:text-6xl gradient-title animate-gradient">
              <motion.span
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              <motion.div
                ...
                style={{ 
                  background: isHovered 
                    ? `radial-gradient(circle at ${(mousePosition.x + 0.5) * 100}% ${(mousePosition.y + 0.5) * 100}%, rgba(124, 58, 237, 0.3) 0%, rgba(0, 0, 0, 0) 70%)` 
                    : "none",
